...
async function refreshEvents() {
  ...
  infobox = infobox
    ...
    .replace(
      '! style="width:21%" class="unsortable" |Notes',
...
function title(title, localPath) {
  return fetch(
    "https://azurlane.koumakan.jp/w/index.php?title=" + encodeURIComponent(title) + "&action=raw",
    localPath
  );
}
